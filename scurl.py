...
context.set_verify(SSL.VERIFY_NONE, callback)					# -- sets the verification mode and the callback function to call when verifying
# context.load_verify_locations(ca_file, ca_path)				# ?? WHAT IS GOING ON HERE

s = socket()													# ?? (socket.AF_INET, socket.SOCK_STREAM)
# s.settimeout(5)												# ?? do i need to do this?
...
connection.connect(("www.facebook.com",443))
